 ...
 */
package matematikarizwan;

/**
 *
 * @author Toshiba
 */
public class MatematikaRizwanCanggihBeraksi {
    public static void main(String[] args) {
        // Membuat objek dari kelas MatematikaRizwan
        MatematikaRizwan mtk = new MatematikaRizwan();
        ...
        // Membuat objek dari kelas MatematikaRizwanCanggih
        MatematikaRizwanCanggih mtkCanggih = new MatematikaRizwanCanggih();

        // Menguji metode tambahan pada kelas MatematikaRizwanCanggih
